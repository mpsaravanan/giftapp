        ...
        <!-- Modal content-->
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="inputuName" class="control-label">Name<span class="requiredstar">*</span></label>
                    <input type="text" class="form-control u_name" name="inputuName" id="inputuName" placeholder="Enter Name" required="required" />
                </div>
                <div class="form-group">
                    <label for="inputuEmail" class="control-label">Email<span class="requiredstar">*</span></label>
